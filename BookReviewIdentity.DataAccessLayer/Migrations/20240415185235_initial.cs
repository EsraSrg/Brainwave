...
namespace BrainWave.DataAccessLayer.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "userProjectProcesses",
                columns: table => new
                {
                    UserProjectProcessID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_userProjectProcesses", x => x.UserProjectProcessID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExperienceInfo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PreviousProjects = table.Column<string>(type: "nvarchar(max)", nullable: false),
