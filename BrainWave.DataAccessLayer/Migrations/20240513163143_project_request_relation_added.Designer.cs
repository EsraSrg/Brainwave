...
namespace BrainWave.DataAccessLayer.Migrations
{
    ...
    [Migration("20240513163143_project_request_relation_added")]
    partial class project_request_relation_added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BrainWave.EntityLayer.Concrete.ProjectRequest", b =>
                {
                    b.HasOne("BrainWave.EntityLayer.Concrete.UserProject", "ReceiverUser")
                        .WithMany("RequestReceiver")
                        .HasForeignKey("ReceiverID");

                    b.HasOne("BrainWave.EntityLayer.Concrete.UserProject", "SenderUser")
                        .WithMany("RequestSender")
